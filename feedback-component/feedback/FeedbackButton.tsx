...
import { Box, Card, CardContent, CardHeader, CardActions, Stack, Grow, IconButton, Button } from "@mui/material";
...
export default function FeedbackButton() {
	...
	const renderStepComponent = () => {
		switch (activeStep) {
			...
			case 2:
				return <ProvideDetailStep inspecting={inspecting} setInspecting={setInspecting} />;
			default:
				return null;
		}
	};
									...
									<>
										...
										<CardActions sx={{ justifyContent: "end" }}>
											<Stack direction="row" justifyContent="flex-end" spacing={2}>
												<Button variant={isDirty ? "contained" : "outlined"} disabled={!isDirty} onClick={handleReset}>
													{"Reset"}
												</Button>
												<LoadingButton
													onClick={onSubmit}
